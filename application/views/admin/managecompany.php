                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="card-body">                                                    
                                                                    ...
                                                                    ?>"" name="type">
                                                                        ...
                                                                        foreach ($type as $data) {
                                                                            ...
                                                                            if (!isset($success) && set_select('type', $data->category_id)) {
                                                                                ...
                                                                                if ($data->category_id == $editcompany->parent_id) {
                                                                                    echo 'selected';
                                                                                }
                                                                            }
                                                                            ?>>
                                                            ...
                                                            <div class="mt-4">
                                                                ...
                                                                &nbsp;
                                                                <a href="<?php echo base_url('manage-company'); ?>" class="btn btn-light w-md">Cancel</a>
                                                            </div>                                                                   
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="card-body">                                                                                                                        
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="company" class="form-control <?php
                                                                if (form_error('company')) {
                                                                    echo 'invalid';
                                                                }
                                                                ?>" placeholder="Enter Company Name" value="<?php
                                                                       if (!isset($success) && set_value('company')) {
                                                                           echo set_value('company');
                                                                       } else {
                                                                           echo $editcompany->name;
                                                                       }
                                                                       ?>"/>
                                                                <p class="errmsg">
                                                                    <?php
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-8">
                                                <h4 class="card-title-mb-3">View All Company</h4>
                                            </div>
                                            <div class="col-4" style="text-align:right;">
                                                <button class="btn btn-danger" onclick="delete_record('company', '<?php echo base64_encode(base64_encode(0)); ?>')" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Delete All Records</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($company as $data) {
                                                    ...
                                                    <tr valign="middle" align="center">
                                                        ...
                                                        <td align="center">
                                                            <a href="<?php echo base_url(); ?>edit-company/<?php echo base64_encode(base64_encode($data->category_id)); ?>" style="color:blue;" >
                                                                <i class="fa fa-pen" title="Edit" data-bs-toggle="tooltip"></i>
                                                            </a>
                                                        </td>
                                                        <td align="center">
                                                            <a href="" style="color:red;" onclick="delete_record('company', '<?php echo base64_encode(base64_encode($data->category_id)); ?>')" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
