                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-8">
                                                <h4 class="card-title-mb-3">View All Contacts</h4>
                                            </div>
                                            <div class="col-4" style="text-align:right;">
                                                <button class="btn btn-danger" onclick="delete_record('contactus', '<?php echo base64_encode(base64_encode(0)); ?>')" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Delete All Records</button>
                                            </div>
                                        </div> 
                                    </div>                                   
                                    <div class="card-body">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($contact_us as $data) {
                                                    ...
                                                    <tr valign="middle" align="center">
                                                        ...
                                                        <td><a href="tel:8980197471" style="color:black"><a href="tel:"><?php echo $data->mobile; ?></a></td>
                                                        <td><?php echo $data->subject; ?></td>
                                                        <td><?php echo $data->message; ?></td>
                                                        <td align="center">
                                                            <a href="" onclick="delete_record('contactus', '<?php echo base64_encode(base64_encode($data->contact_id)); ?>')" style="color:red;" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
