                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-8">
                                            <h4 class="card-title-mb-3">View All Models</h4>
                                        </div>
                                        <div class="col-4" style="text-align:right;">
                                            <button class="btn btn-danger" onclick="delete_record('model', '<?php echo base64_encode(base64_encode(0)); ?>')" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Delete All Records</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($model as $data) {
                                                ...
                                                <tr valign="middle" align="center">
                                                    ...
                                                    <td align="center">
                                                        <a href="" style="color:red;" onclick="delete_record('model', '<?php echo base64_encode(base64_encode($data->category_id)) ?>')"  data-bs-toggle="modal" data-bs-target="#staticBackdrop">
