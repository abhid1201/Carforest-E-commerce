                                                        ...
                                                        <center>
                                                            <div class="input-group">
                                                                <div class="custom-file">
                                                                    <input id="imgInp" name="banner" class="form-control" type="file"> 
                                                                </div>
                                                            </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-8">
                                                <h4 class="card-title-mb-3">View All Banner</h4>
                                            </div>
                                            <div class="col-4" style="text-align:right;">
                                                <button class="btn btn-danger" onclick="delete_record('banner', '<?php echo base64_encode(base64_encode(0)); ?>')" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Delete All Records</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                                    ...
                                                    <tr valign="middle" align="center">
                                                        ...
                                                        <td>
                                                            <a onclick="change_status('banner', <?php echo $data->banner_id; ?>)" id="status_<?php echo $data->banner_id; ?>" data-toggle="tooltip" data-placement="bottom" title="Active">
                                                                ...
                                                                if ($data->status == 1) {
                                                                    ?>
                                                                    <i class="fa fa-toggle-on" style="color: green;cursor: pointer" onclick="delete_record('banner', '<?php echo base64_encode(base64_encode($data->banner_id)); ?>')" data-toggle="tooltip" data-placement="bottom" title="Active"  ></i>
                                                                    <?php
                                                                } else {
                                                                    ?>
                                                        ...
                                                        <td align="center">
                                                            <a style="color:red; cursor: pointer" onclick="delete_record('banner', '<?php echo base64_encode(base64_encode($data->banner_id)); ?>')" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
