...
<html>
    ...
    <body class="m-home" data-scrolling-animations="true" data-equal-height=".b-auto__main-item">
        ...
        <section class="b-pageHeader">
            <div class="container">
                <h1 class="wow zoomInLeft" data-wow-delay="0.7s">Log In</h1>
        ...
        <div class="b-breadCumbs s-shadow">
            <div class="container">
                <a href="<?php echo base_url('home'); ?>" class="b-breadCumbs__page">Home</a><span class="fa fa-angle-right"></span><a href="<?php echo base_url('login'); ?>" class="b-breadCumbs__page m-active">Log In</a>
            </div>
        </div><!--b-breadCumbs-->                
                ...
                <div class="row">
                        ...
                        <div class="b-contacts__form">
                            ...
                            <form action="" method="post" id="contactForm" novalidate class="s-form wow zoomInUp" data-wow-delay="0.5s">
                                ...
                                <div>
                                    ...
                                    ?>" name="user-login-password" id="user-login-password">
                                    <a><i class="fa-solid fa-eye eye_icon_3" id="password"></i></a>                       
                                </div>
                                <div>
                                    <p class="wow zoomInUp rememberme" data-wow-delay="0.5s">
                                    ...
                                    <a href="<?php echo base_url('forget-password'); ?>" class="frgt_ps">Forget Password ?</a>
                                </div>
                                <div>
                    ...
                    <div class = "col-xs-6">
                        <div class = "b-contacts__form">
                            ...
                            <p class = " wow zoomInUp" data-wow-delay = "0.5s">By register with us you will be able to, see all carmela, put your favourite car in your favourite list, book your appointment to test car and many more.</p>
                            <form action = "" method = "post" id = "contactForm" novalidate class = "s-form wow zoomInUp" data-wow-delay = "0.5s">
