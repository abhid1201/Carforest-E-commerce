                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title-mb-3">View All Subscriber</h4>
                                            ...
                                            <tbody>
                                                ...
                                                for ($i == 1; $i <= 60; $i++) {
                                                    ...
                                                    <tr valign="middle" align="center">
                                                        ...
                                                        <td><a href="mailto:akashsanepara@gmail.com" style="color:black">akashsanepara@gmail.com</a></td>                                    
                                                        <td align="center">
                            ...
                            <div class="col-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title-mb-3">Send Email</h4>
                                    </div>
                                    <div class="card-body">
                                        <form>
                                            <table id="datatable-buttons" class="table table-bordered dt-responsive w-100">                                            
                                                <div class="mb-3">
                                                    <label class="form-label" for="formrow-firstname-input">Subject</label>
                                                    <input type="text" class="form-control" id="formrow-firstname-input" placeholder="Enter your subject"/>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label" for="formrow-firstname-input">Message</label>
                                                    <input type="text" class="form-control" id="formrow-firstname-input" placeholder="Enter your message"/>
                                                </div>
                                                <div class="mt-4">
