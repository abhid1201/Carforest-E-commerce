                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">My Car Review</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url('member-home') ?>">Dashboard</a></li>
                                            <li class="breadcrumb-item active">My Car Review</li>
                                        </ol>
                                    </div>
                                ...
                                <div class="card">                                  
                                    <div class="card-body">
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive w-100">
                                            ...
                                            <tbody>                                                
                                                <?php
                                                $car_review = $this->md->my_select('tbl_car_review', '*', array('register_id' => $this->session->userdata('member')));
                                                $i = 0;
                                                foreach ($car_review as $data) {
                                                    ...
                                                    $carmela = $this->md->my_select('tbl_carmela', '*', array('carmela_id' => $car->car_id))[0]->carmela_name;
                                                    ?>
                                                    <tr valign="middle" align="center">
                                                        ...
                                                        <td>
                                                            ...
                                                            if ($data->status == 0) {
                                                                ?>
                                                                <span class="badge bg-warning text-white text-dark w-50">Pending</span>
                                                                <?php
                                                            } else {
                                                                ?>
                                                                <span class="badge bg-primary text-dark text-white w-50">Active</span>
                                                                <?php
                                                            }
                                                            ?>
                                                        </td>
                                                        <td align="center">
                                                            <a style="color:red; cursor: pointer" onclick="delete_record('member-review', '<?php echo base64_encode(base64_encode($data->review_id)); ?>')" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
