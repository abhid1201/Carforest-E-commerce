                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-8">
                                                <h4 class="card-title-mb-3">Car Reviews</h4>
                                            </div>
                                        </div> 
                                    </div>                                   
                                    <div class="card-body">
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive w-100">
                                            ...
                                            <tbody>
                                                <?php
                                                $car_review = $this->md->my_query("SELECT r.* FROM `tbl_car_review` AS r, `tbl_car` AS c WHERE r.`car_id` = c.`car_id` AND c.`carmela_id` = " . $this->session->userdata('carmela') . ";");
                                                $i = 0;
                                                    ...
                                                    <tr valign="middle" align="center">
                                                        ...
                                                        <td>
                                                            ...
                                                            if (strlen($member->profile_pic) > 0) {
                                                                ?>
                                                                <img class="rounded-circle header-profile-user" src="<?php echo base_url() . $path[0]; ?>" title="<?php echo $member->name; ?>" data-bs-toggle="tooltip">
                                                                <?php
                                                            } else {
                                                                ?>
                                                        ...
                                                        <td>
                                                            ...
                                                            if ($data->status == 0) {
                                                                ...
                                                                ?>
                                                                <span class="badge bg-success text-dark text-white w-50">Active</span>
                                                                <?php
                                                            }
                                                            ?>
                                                        </td>
