<header id="page-topbar">
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            <?php
            $details = $this->md->my_select('tbl_carmela', '*', array('carmela_id' => $this->session->userdata('carmela')))[0];
            ?>
            <div class="container dropdown d-inline-block" style="width:220px;">
                <div class="row">
                    ...
                    <div class="col-md-9 ps-4 pt-3">
                        <span class="d-none d-xl-inline-block ms-1 fw-medium"><?php echo $details->carmela_name; ?></span>
                        <br/>
