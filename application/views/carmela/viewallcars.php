                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">My Cars</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url('carmela-home') ?>">Dashboard</a></li>
                                                    ...
                                                    <tr valign="middle" align="center">
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?php echo base_url().$path[0]; ?>" target="_blank">
                                                                <img class="rounded" style="width: 75px;" src="<?php echo base_url().$path[0]; ?>" title="<?php echo $data->name; ?> " data-bs-toggle="tooltip">
                                                            </a>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url() ?>car-detail/<?php echo base64_encode(base64_encode($data->car_id)); ?>" target="_blank">View More</a>
                                                        </td>
                                                        <td>
                                                            <?php
                                                            if ($data->status == 1) {
                                                                ?>
                                                                <span class="badge bg-soft-success text-success" data-bs-toggle="tooltip" title="Active">Active</span>
                                                                <?php
                                                            } else {
                                                                ?>
                                                                <span class="badge bg-soft-danger text-danger" data-bs-toggle="tooltip" title="Pending">Pending</span>
                                                                <?php
                                                            }
                                                            ?>
                                                            </a>    
                                                        ...
                                                        <td align="center">
                                                            <a href="" style="color:red;" onclick="delete_record('car', '<?php echo base64_encode(base64_encode($data->car_id)); ?>')"  data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticBackdropLabel"><i class="fa-solid fa-exclamation-triangle"></i> Confirmation</h5>
