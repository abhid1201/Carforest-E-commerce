                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-8">
                                                <h4 class="card-title-mb-3">View All Subscriptions</h4>
                                            </div>
                                        </div> 
                                    </div>                                   
                                    <div class="card-body">
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive w-100">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($bill as $data) {
                                                    ...
                                                    $package_info = $this->md->my_select('tbl_package','*',array('package_id'=>$data->package_id))[0];
                                                    ?>
                                                    <tr valign="middle" align="center">
                                                        <td><?php echo $i; ?></td>
                                                        <td><?php echo $data->order_id; ?></td>
                                                        <td><?php echo $data->payment_id; ?></td>
                                                        <td><?php echo $package_info->name; ?></td>
                                                        <td><?php echo $data->amount; ?></td>
                                                        <td><?php echo date('d-m-Y', strtotime($data->start_date)); ?></td>
                                                        <td><?php echo date('d-m-Y', strtotime($data->end_date)); ?></td>
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>carmela-view-invoice/<?php echo base64_encode(base64_encode($data->bill_id)); ?>">View</a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
